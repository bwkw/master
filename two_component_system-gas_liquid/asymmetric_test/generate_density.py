...
type1_x_list = []
type2_x_list = []
loadfile("../../../../../../work/k0117/k011706/asymmetric_test/data/dump.melt/L{}T{}/lan{}-lbn{}-ran{}-rbn{}.dump".format(length, temperature, left_a_num, left_b_num, right_a_num, right_b_num))
