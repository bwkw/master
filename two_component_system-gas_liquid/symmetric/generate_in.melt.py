...
def make_file(filename, length, temperature, left_a_num, left_b_num, right_a_num, right_b_num):
    with open(filename, "w") as f:
        ...
        f.write("read_data data/atoms/L{}/lan{}-lbn{}-ran{}-rbn{}.atoms".format(length, left_a_num, left_b_num, right_a_num, right_b_num))
        f.write("mass 1 1.0\n")
        f.write("mass 2 1.0\n\n")
        ...
        f.write("run 500000\n\n")
        f.write("dump id all atom 1000 data/dump.melt/L{}T{}/lan{}-lbn{}-ran{}-rbn{}.dump".format(length, temperature, left_a_num, left_b_num, right_a_num, right_b_num))
        f.write("run 5000")
