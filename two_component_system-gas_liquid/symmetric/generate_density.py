...
type1_density_list = list(map(lambda x: x/(0.001*half_volume*2*1000), type1_density_list))
type2_density_list = list(map(lambda x: x/(0.001*half_volume*2*1000), type2_density_list))
