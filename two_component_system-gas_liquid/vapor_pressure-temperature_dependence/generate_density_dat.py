...
for i in range(1, int(sys.argv[1])):
    ...
    if not os.path.exists('density_dat/T{}'.format(temperature)):
        os.mkdir(('density_dat/T{}'.format(temperature)))
    
    makefile("density_dat/T{}/lna{}-lnb{}-lda{}-ldb{}.dat".format(temperature, left_num_a, left_num_b, left_density_a, left_density_b), type1_density_list, type2_density_list)
