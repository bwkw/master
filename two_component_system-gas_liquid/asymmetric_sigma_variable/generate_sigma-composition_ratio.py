...
def makefile(filename, sigma, composition_ratio_average, composition_ratio_uncertainity):
     with open(filename, "a") as f:
        f.write('{} {} {}\n'.format(sigma, 1-composition_ratio_average, composition_ratio_uncertainity))
...
for file in files:
    ...
    for i in range(len(composition_ratios)-1):
        ...
        if ((y1_average > 0) and (y2_average < 0)):
            ...
            makefile('sigma-composition_ratio.dat', sigma, composition_ratio_average, composition_ratio_uncertainity)
            break
