...
def make_file(filename, length, temperature, variable_sigma, left_a_num, left_b_num, right_a_num, right_b_num):
...
make_base_file("task/lammps/run/L{}T{}C{}S{}.sh".format(length, temperature, composition_number, variable_sigma))
...
for i in range(1, composition_number):
    ...
    make_file("task/lammps/run/L{}T{}C{}S{}.sh".format(length, temperature, composition_number, variable_sigma), length, temperature, variable_sigma, left_a_num, left_b_num, right_a_num, right_b_num)

make_end_file("task/lammps/run/L{}T{}C{}S{}.sh".format(length, temperature, composition_number, variable_sigma))
