...
def make_lammps_file(filename, length, temperature, variable_epsilon, left_a_num, left_b_num, right_a_num, right_b_num):
    with open(filename, "a") as f:
        f.write("srun --exclusive --mem-per-cpu=1840 -n 512 -c 1 -N 4 lammps < data/in.melt/L{}T{}E{}/lan{}-lbn{}-ran{}-rbn{}.in\n".format(length, temperature, variable_epsilon, left_a_num, left_b_num, right_a_num, right_b_num))

def make_lammps_end_file(filename):
    with open(filename, "a") as f:
        f.write("wait\n")

def make_atoms_file(filename, length, temperature, a_composition_ratio, variable_epsilon):
    with open(filename, "a") as f:
        f.write("python3 generate_atoms.py < data/param/L{}T{}E{}/AC{}.param\n".format(length, temperature, variable_epsilon, a_composition_ratio))

def make_density_file(filename, length, temperature, a_composition_ratio, variable_epsilon):
    with open(filename, "a") as f:
        f.write("python3 generate_density.py < data/param/L{}T{}E{}/AC{}.param\n".format(length, temperature, variable_epsilon, a_composition_ratio))

def make_density_fitting_plt_file(filename, length, temperature, a_composition_ratio, variable_epsilon):
    with open(filename, "a") as f:
        f.write("python3 generate_density_fitting_plt.py < data/param/L{}T{}E{}/AC{}.param\n".format(length, temperature, variable_epsilon, a_composition_ratio))

def make_inmelt_file(filename, length, temperature, a_composition_ratio, variable_epsilon):
    with open(filename, "a") as f:
        f.write("python3 generate_in.melt.py < data/param/L{}T{}E{}/AC{}.param\n".format(length, temperature, variable_epsilon, a_composition_ratio))
...
make_lammps_base_file("task/lammps/run/L{}T{}CN{}E{}.sh".format(length, temperature, composition_number, variable_epsilon))
...
make_lammps_end_file("task/lammps/run/L{}T{}CN{}E{}.sh".format(length, temperature, composition_number, variable_epsilon))
