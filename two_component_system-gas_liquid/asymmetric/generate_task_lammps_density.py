...
def make_file(filename, length, temperature, a_composition_ratio):
    with open(filename, "a") as f:
        f.write("python3 generate_density.py < data/param/L{}T{}/C{}.param\n".format(length, temperature, a_composition_ratio))
...
for i in range(1, composition_number):
    ...
    make_file("task/lammps/density/L{}T{}C{}.sh".format(length, temperature, composition_number), length, temperature, a_composition_ratio)
