...
def make_file(filename, left_num, right_num, temperature):
...
temperature = 1.0
make_file("input/ln{}-rn{}-T{}.input".format(left_num, right_num, temperature), left_num, right_num, temperature)
