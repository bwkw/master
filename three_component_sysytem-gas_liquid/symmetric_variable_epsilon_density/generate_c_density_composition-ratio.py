...
def makefile(filename, c_density, average_composition_ratio, min_composition_ratio, max_composition_ratio):
     with open(filename, "a") as f:
        f.write('{} {} {} {}\n'.format(c_density, average_composition_ratio, min_composition_ratio, max_composition_ratio))
...
for file in files:
    ...
    for i in range(len(composition_ratios)-1):
        ...
        if ((average_x_1 < 0) and (average_x_2 > 0)):
            ...
            makefile('c_density_composition-ratio.dat', c_density, average_composition_ratio, min_composition_ratio, max_composition_ratio)
            break
