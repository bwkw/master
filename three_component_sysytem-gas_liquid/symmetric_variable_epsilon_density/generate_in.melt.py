...
def make_file(filename, length, temperature, left_a_num, left_b_num, right_a_num, right_b_num, variable_epsilon, c_density):
    with open(filename, "w") as f:
        ...
        f.write("pair_coeff 2 3 0.9 1.05 1.12246\n")
        f.write("pair_coeff 3 3 1.0 1.0 3.0\n")
        f.write("fix 1 all nvt temp {} {} 0.01\n\n".format(temperature, temperature))
        f.write("run 3000000\n\n")
        f.write("dump id all atom 1000 ../../../../../../work/k0117/k011706/symmetric_variable_epsilon_density/data/dump.melt/L{}T{}E{}CD{}/lan{}-lbn{}-ran{}-rbn{}.dump\n\n".format(length, temperature, variable_epsilon, c_density, left_a_num, left_b_num, right_a_num, right_b_num))
        f.write("run 1000000")
...
make_file("data/in.melt/L{}T{}E{}CD{}/lan{}-lbn{}-ran{}-rbn{}.in".format(length, temperature, variable_epsilon, c_density, left_a_num, left_b_num, right_a_num, right_b_num),
length, temperature, left_a_num, left_b_num, right_a_num, right_b_num, variable_epsilon, c_density)
