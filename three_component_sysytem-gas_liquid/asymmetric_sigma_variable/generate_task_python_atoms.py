...
for i in range(1, composition_number):
    ...
    make_file("task/python/atoms/L{}C{}atoms.sh".format(length, composition_number), length, temperature, a_composition_ratio, variable_sigma)
