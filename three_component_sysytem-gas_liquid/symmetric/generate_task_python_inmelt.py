...
for i in range(1, composition_number):
    ...
    make_file("task/python/in.melt/L{}T{}C{}E{}inmelt.sh".format(length, temperature, composition_number, variable_epsilon), length, temperature, a_composition_ratio, variable_epsilon)
